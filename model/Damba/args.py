...
def load_rel_2(adj_mx, args, dataset):
    directory = f'../data/Damba/{dataset}'
...
def parse_args(parser, args_base):
    # get configuration
    config_file = '../conf/Damba/Damba.conf'
    ...
    for dataset_select in (args_base.dataset_use):
        ...
        if dataset_select == 'PEMS08' or dataset_select == 'PEMS04' or dataset_select == 'PEMS07':
            ...
            distance_df_filename = args_predictor.filepath + f'{dataset_select}_rn_adj.npy'
        A, walk_node_idx, walk_edge_idx, walk_pe = get_adjacency_matrix(
        ...
        walk_path_dict[dataset_select] = walk_node_idx
        walk_edge_dict[dataset_select] = walk_edge_idx
        walk_pe_dict[dataset_select] = walk_pe
    ...
    args_predictor.walk_path_dict=walk_path_dict
    args_predictor.walk_edge_dict=walk_edge_dict
    args_predictor.walk_pe_dict=walk_pe_dict
